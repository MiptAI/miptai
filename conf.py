...
BLOG_AUTHOR = "MIPT"  # (translatable)
BLOG_TITLE = "MIPT.AI"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://mipt.ai/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://mipt.ai/"
BLOG_EMAIL = "ninja@mipt.ai"
BLOG_DESCRIPTION = "MIPT"  # (translatable)
...
GITHUB_REMOTE_NAME = 'github-pages'
...
def format_date(value, fmt):
    if not isinstance(value, datetime.datetime):
        value = nikola.utils.to_datetime(value)
...
GLOBAL_CONTEXT = {
    'VK_LINK': 'https://vk.com/aimipt',
    'TELEGRAM_LINK': 'https://t.me/aimipt',
}
